...
public class Destinations extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel", " Sun and Sand ", " Rambagh Palace", "The Leela Palace", "The Oberoi", "The Taj Mahal Palace", "Snow Flakes Resort ", "SeaShores", "Woodrock ", "Radisson Blu "};
        try {
            for (int i = 0; i < 9; i++) {
    ...
    public Destinations() { // This is the constructor
    ...
    public static void main(String[] args) {
        new Destinations(); // This creates an instance, calling the constructor
    }
}
